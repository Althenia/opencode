...
import { locationID, VariantPluginID } from "./contracts"
...
export interface Dependencies {
  ...
  readonly variantWait: PluginV2.Interface["wait"]
  ...
  readonly materialize: SessionRunnerModel.Interface["materialize"]
}
        ...
        make(
          {
            ...
            materialize: models.materialize,
          },
          workloadBinding,
        ),
      )
...
const supported = (model: {
  readonly api: { readonly type: string; readonly package?: string; readonly url?: string }
}) =>
