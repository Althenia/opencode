...
const model = (id: string, providerID = "provider") =>
  ModelV2.Info.make({
    ...
    providerID: ProviderV2.ID.make(providerID),
    name: id,
    api: { id: ModelV2.ID.make(id), type: "aisdk", package: "@ai-sdk/openai", url: "https://openai.example/v1" },
    capabilities: { tools: true, input: ["text"], output: ["text"] },
    enabled: true,
    request: { headers: {}, body: {} },
    variants: [{ id: ModelV2.VariantID.make("configured"), headers: {}, body: {} }],
    time: { released: 0 },
    cost: [],
    status: "active",
