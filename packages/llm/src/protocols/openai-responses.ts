...
// Stream Parsing
// =============================================================================
// OpenAI Responses reports `input_tokens` (inclusive total) with cached and
// cache-write subsets, and `output_tokens` with a reasoning subset. Pass the
// totals through and derive the non-cached breakdown.
