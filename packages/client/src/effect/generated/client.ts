...
const adaptGroup5 = (raw: RawClient["server.session"]) => ({
  ...
  synthetic: Endpoint5_24(raw),
  shell: Endpoint5_25(raw),
  compact: Endpoint5_26(raw),
  wait: Endpoint5_27(raw),
  revert: { stage: Endpoint5_28(raw), clear: Endpoint5_29(raw), commit: Endpoint5_30(raw) },
  context: Endpoint5_31(raw),
  pending: { list: Endpoint5_32(raw) },
  instructions: { entry: { list: Endpoint5_33(raw), put: Endpoint5_34(raw), remove: Endpoint5_35(raw) } },
  generate: Endpoint5_36(raw),
  log: Endpoint5_37(raw),
  interrupt: Endpoint5_38(raw),
  background: Endpoint5_39(raw),
  message: Endpoint5_40(raw),
})
