...
const adaptGroup5 = (raw: RawClient["server.session"]) => ({
  ...
  todo: { list: Endpoint5_8(raw), update: Endpoint5_9(raw) },
  fork: Endpoint5_10(raw),
  switchAgent: Endpoint5_11(raw),
  switchModel: Endpoint5_12(raw),
  rename: Endpoint5_13(raw),
  move: Endpoint5_14(raw),
  prompt: Endpoint5_15(raw),
  command: Endpoint5_16(raw),
  skill: Endpoint5_17(raw),
  synthetic: Endpoint5_18(raw),
  shell: Endpoint5_19(raw),
  compact: Endpoint5_20(raw),
  wait: Endpoint5_21(raw),
  revert: { stage: Endpoint5_22(raw), clear: Endpoint5_23(raw), commit: Endpoint5_24(raw) },
  context: Endpoint5_25(raw),
  pending: { list: Endpoint5_26(raw) },
