...
type Endpoint5_24Request = Parameters<RawClient["server.session"]["session.synthetic"]>[0]
export type Endpoint5_24Input = {
  ...
  readonly description?: Endpoint5_24Request["payload"]["description"]
...
export type Endpoint5_24Output = EffectValue<ReturnType<RawClient["server.session"]["session.synthetic"]>>["data"]
export type SessionSyntheticOperation<E = never> = (input: Endpoint5_24Input) => Effect.Effect<Endpoint5_24Output, E>

type Endpoint5_25Request = Parameters<RawClient["server.session"]["session.shell"]>[0]
...
export type Endpoint5_25Output = EffectValue<ReturnType<RawClient["server.session"]["session.shell"]>>
export type SessionShellOperation<E = never> = (input: Endpoint5_25Input) => Effect.Effect<Endpoint5_25Output, E>

type Endpoint5_26Request = Parameters<RawClient["server.session"]["session.compact"]>[0]
...
export type Endpoint5_26Output = EffectValue<ReturnType<RawClient["server.session"]["session.compact"]>>["data"]
export type SessionCompactOperation<E = never> = (input: Endpoint5_26Input) => Effect.Effect<Endpoint5_26Output, E>

type Endpoint5_27Request = Parameters<RawClient["server.session"]["session.wait"]>[0]
export type Endpoint5_27Input = { readonly sessionID: Endpoint5_27Request["params"]["sessionID"] }
export type Endpoint5_27Output = EffectValue<ReturnType<RawClient["server.session"]["session.wait"]>>
export type SessionWaitOperation<E = never> = (input: Endpoint5_27Input) => Effect.Effect<Endpoint5_27Output, E>

type Endpoint5_28Request = Parameters<RawClient["server.session"]["session.revert.stage"]>[0]
export type Endpoint5_28Input = {
  readonly sessionID: Endpoint5_28Request["params"]["sessionID"]
  readonly messageID: Endpoint5_28Request["payload"]["messageID"]
  readonly files?: Endpoint5_28Request["payload"]["files"]
}
export type Endpoint5_28Output = EffectValue<ReturnType<RawClient["server.session"]["session.revert.stage"]>>["data"]
export type SessionRevertStageOperation<E = never> = (input: Endpoint5_28Input) => Effect.Effect<Endpoint5_28Output, E>

type Endpoint5_29Request = Parameters<RawClient["server.session"]["session.revert.clear"]>[0]
export type Endpoint5_29Input = { readonly sessionID: Endpoint5_29Request["params"]["sessionID"] }
export type Endpoint5_29Output = EffectValue<ReturnType<RawClient["server.session"]["session.revert.clear"]>>
export type SessionRevertClearOperation<E = never> = (input: Endpoint5_29Input) => Effect.Effect<Endpoint5_29Output, E>

type Endpoint5_30Request = Parameters<RawClient["server.session"]["session.revert.commit"]>[0]
export type Endpoint5_30Input = { readonly sessionID: Endpoint5_30Request["params"]["sessionID"] }
export type Endpoint5_30Output = EffectValue<ReturnType<RawClient["server.session"]["session.revert.commit"]>>
export type SessionRevertCommitOperation<E = never> = (input: Endpoint5_30Input) => Effect.Effect<Endpoint5_30Output, E>

type Endpoint5_31Request = Parameters<RawClient["server.session"]["session.context"]>[0]
export type Endpoint5_31Input = { readonly sessionID: Endpoint5_31Request["params"]["sessionID"] }
export type Endpoint5_31Output = EffectValue<ReturnType<RawClient["server.session"]["session.context"]>>["data"]
export type SessionContextOperation<E = never> = (input: Endpoint5_31Input) => Effect.Effect<Endpoint5_31Output, E>

type Endpoint5_32Request = Parameters<RawClient["server.session"]["session.pending.list"]>[0]
export type Endpoint5_32Input = { readonly sessionID: Endpoint5_32Request["params"]["sessionID"] }
export type Endpoint5_32Output = EffectValue<ReturnType<RawClient["server.session"]["session.pending.list"]>>["data"]
export type SessionPendingListOperation<E = never> = (input: Endpoint5_32Input) => Effect.Effect<Endpoint5_32Output, E>

type Endpoint5_33Request = Parameters<RawClient["server.session"]["session.instructions.entry.list"]>[0]
export type Endpoint5_33Input = { readonly sessionID: Endpoint5_33Request["params"]["sessionID"] }
export type Endpoint5_33Output = EffectValue<
...
type Endpoint5_34Request = Parameters<RawClient["server.session"]["session.instructions.entry.put"]>[0]
export type Endpoint5_34Input = {
  readonly sessionID: Endpoint5_34Request["params"]["sessionID"]
  readonly key: Endpoint5_34Request["params"]["key"]
  readonly value: Endpoint5_34Request["payload"]["value"]
}
export type Endpoint5_34Output = EffectValue<ReturnType<RawClient["server.session"]["session.instructions.entry.put"]>>
export type SessionInstructionsEntryPutOperation<E = never> = (
  input: Endpoint5_34Input,
) => Effect.Effect<Endpoint5_34Output, E>

type Endpoint5_35Request = Parameters<RawClient["server.session"]["session.instructions.entry.remove"]>[0]
...
type Endpoint5_36Request = Parameters<RawClient["server.session"]["session.generate"]>[0]
export type Endpoint5_36Input = {
  readonly sessionID: Endpoint5_36Request["params"]["sessionID"]
  readonly prompt: Endpoint5_36Request["payload"]["prompt"]
}
export type Endpoint5_36Output = EffectValue<ReturnType<RawClient["server.session"]["session.generate"]>>["data"]
export type SessionGenerateOperation<E = never> = (input: Endpoint5_36Input) => Effect.Effect<Endpoint5_36Output, E>

type Endpoint5_37Request = Parameters<RawClient["server.session"]["session.log"]>[0]
export type Endpoint5_37Input = {
  readonly sessionID: Endpoint5_37Request["params"]["sessionID"]
  readonly after?: Endpoint5_37Request["query"]["after"]
  readonly follow?: Endpoint5_37Request["query"]["follow"]
}
export type Endpoint5_37Output = StreamValue<EffectValue<ReturnType<RawClient["server.session"]["session.log"]>>>
export type SessionLogOperation<E = never> = (input: Endpoint5_37Input) => Stream.Stream<Endpoint5_37Output, E>

type Endpoint5_38Request = Parameters<RawClient["server.session"]["session.interrupt"]>[0]
export type Endpoint5_38Input = { readonly sessionID: Endpoint5_38Request["params"]["sessionID"] }
export type Endpoint5_38Output = EffectValue<ReturnType<RawClient["server.session"]["session.interrupt"]>>
export type SessionInterruptOperation<E = never> = (input: Endpoint5_38Input) => Effect.Effect<Endpoint5_38Output, E>

type Endpoint5_39Request = Parameters<RawClient["server.session"]["session.background"]>[0]
export type Endpoint5_39Input = { readonly sessionID: Endpoint5_39Request["params"]["sessionID"] }
export type Endpoint5_39Output = EffectValue<ReturnType<RawClient["server.session"]["session.background"]>>
export type SessionBackgroundOperation<E = never> = (input: Endpoint5_39Input) => Effect.Effect<Endpoint5_39Output, E>

type Endpoint5_40Request = Parameters<RawClient["server.session"]["session.message"]>[0]
export type Endpoint5_40Input = {
  readonly sessionID: Endpoint5_40Request["params"]["sessionID"]
  readonly messageID: Endpoint5_40Request["params"]["messageID"]
}
export type Endpoint5_40Output = EffectValue<ReturnType<RawClient["server.session"]["session.message"]>>["data"]
export type SessionMessageOperation<E = never> = (input: Endpoint5_40Input) => Effect.Effect<Endpoint5_40Output, E>
