...
type Endpoint3_9Request = Parameters<RawClient["server.session"]["session.goal.start"]>[0]
...
type Endpoint3_10Request = Parameters<RawClient["server.session"]["session.goal.resume"]>[0]
...
type Endpoint3_11Request = Parameters<RawClient["server.session"]["session.goal.stop"]>[0]
...
const Endpoint3_11 = (raw: RawClient["server.session"]) => (input: Endpoint3_11Input) =>
  raw["session.goal.stop"]({ params: { sessionID: input["sessionID"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint3_12Request = Parameters<RawClient["server.session"]["session.goal.status"]>[0]
...
const Endpoint3_12 = (raw: RawClient["server.session"]) => (input: Endpoint3_12Input) =>
  raw["session.goal.status"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )
...
const adaptGroup3 = (raw: RawClient["server.session"]) => ({
  ...
  goalStart: Endpoint3_9(raw),
  goalResume: Endpoint3_10(raw),
  goalStop: Endpoint3_11(raw),
  goalStatus: Endpoint3_12(raw),
